...
class SimulationService{
    ...
    try {
        ...
        `${this.base}/inicializar?anchoGrafo=${this.widthGrid}&altoGrafo=${this.heightGrid}`,null
        );
    ...
    public static async initSimulation(timerSimulacion:number,minutosPorIteracion:number,
        dia:number,mes:number,anio:number,minutoInicial:number,horaInicial:number) : Promise<HttpResponse>{
    ...
    public static async simulacionPedidoSemanal(anio:number,mes:number,dia:number,hora:number,minuto:number): Promise<HttpResponse>{
        const queryParams = new URLSearchParams();
        queryParams.append("anio",anio.toString());
        queryParams.append("mes",mes.toString());
        queryParams.append("dia",dia.toString());
    ...
    public static async simulacionBloqueosSemanal(anio:number,mes:number,dia:number,hora:number,minuto:number): Promise<HttpResponse>{
        const queryParams = new URLSearchParams();
        queryParams.append("anio",anio.toString());
        queryParams.append("mes",mes.toString());
        queryParams.append("dia",dia.toString());
    ...
    public static async obtenerRutasVehiculosSemanal(anio:number,mes:number,timeSimulacion:number,minutosPorIteracion:number, averias?: AveriaI[]): Promise<HttpResponse> {
        const queryParams = new URLSearchParams();
        queryParams.append("anio",anio.toString());
        queryParams.append("mes",mes.toString());
        ...
        try{
            ...
            const averiasAEnviar = averias || (this.averiasPendientes.length > 0 ? this.averiasPendientes : null);
    ...
    public static async obtenerRutasVehiculosDiario(anio:number, mes:number, timeSimulacion:number, minutosPorIteracion:number, fechaFin?: string, averias?: AveriaI[]): Promise<HttpResponse> {
        const queryParams = new URLSearchParams();
        queryParams.append("anio", anio.toString());
        queryParams.append("mes", mes.toString());
        queryParams.append("timer", timeSimulacion.toString());
