...
import PedidoCanvas from "@/components/map/StoreHouse/Pedido";
...
export function generatePedidos(pedidos: PedidoI[],timerSimulacion:number,pedidosEntregados:number[]) {
