  ...
  return (
    isWating && (
      ...
      >
        ...
        {/* Cinta superior */}
        <Line points={[36, 10, 60, 10, 60, 70, 36, 78]} closed fill="#a05a2c" />

        {/* Cinta frontal */}
        <Line points={[36, 78, 36, 138, 60, 130, 60, 70]} closed fill="#804000" />
...
export const ToolTipPedido = ({ pedido, posX, posY }: ToolTipPedidoProps) => {
  ...
  return (
    <Group x={posX} y={posY}>
      ...
      <Circle fill="#f4c167" width={10} height={10} offsetY={-19} offsetX={-11} />
      <Text
      ...
      <Text
        ...
        offsetY={-80}
        fontSize={12}
        text={`Hora: ${pedido.hora.toString().padStart(2, "0")}:${pedido.minuto
          .toString()
          .padStart(2, "0")}`}
      />
    </Group>
