...
import {  Calendar, CheckCircle, Clock, Package, Timer,BarChart3, RefreshCw, AlertTriangle, XCircle, Target, MapPin, User } from "lucide-react"
...
export const  FinishModal = ({isOpen} : FinishModalProps) =>{
   ...
   const {manageTime,realTime,simulationTime, setFinish, tipoFinalizacion, pedidosVencidos} = useMapContext();
   ...
   return(
       <Dialog open={isOpen} >
           <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
               <DialogHeader>
                   <div className={`w-16 h-16 mx-auto ${colorFondo} rounded-full flex items-center justify-center`}>
                       {iconoModal}
                   </div>
         ...
         <div className="w-full grid grid-cols-2 gap-4">
           <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
               <div className="flex flex-col items-center space-y-2">
                   ...
                   <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Fecha Inicio de Simulación </span>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
               <div className="flex flex-col items-center space-y-2">
                   <Calendar className="w-6 h-6 text-blue-600" />
                   <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Fecha Fin de Simulación</span>
           ...
           <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
               <div className="flex flex-col items-center space-y-2">
                   ...
                   <span className="text-xs font-medium text-gray-600 uppercase">Pedidos Entregados</span>
                   {isLoadingPedidos ? (
           ...
           <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
               <div className="flex flex-col items-center space-y-2">
                   ...
                   <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Tiempo Real Transcurrido</span>
                           ...
                           <div key={pedido.id} className="bg-white p-3 border border-red-300 rounded-md">
                               <div className="grid grid-cols-2 gap-2 text-sm">
                                   ...
                                   <div className="flex items-center gap-2">
                                       ...
                                       <span>{pedido.dia}/{pedido.mesPedido} {pedido.hora}:{String(pedido.minuto).padStart(2, '0')}</span>
                                   </div>
                                   <div className="flex items-center gap-2">
                                   ...
                                   <div className="flex items-center gap-2 col-span-2">
                                       ...
                                       <span>({pedido.posX}, {pedido.posY})</span>
                                   </div>
                               </div>
                           </div>
                       ))}
